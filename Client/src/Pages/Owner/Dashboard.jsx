                ...
                {data.recentBookings.map((booking, index) => (
                    <div key={index} className='mt-4 flex items-center justify-between'>
                        <div className='flex items-center gap-2'>
                            <div className='hidden md:flex items-center justify-center w-12 h-12 rounded-full bg-[var(--color-light)]'>
                        ...
                        <div className='flex items-center gap-2 font-medium'>
                            ...
                            <p className='px-3 py-0.5 border border-[var(--color-borderColor)] rounded-full text-sm'>{booking.status}</p>
                        </div>
                    </div>
                ))}
            </div>
