        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12'>
          ...
          <div className='lg:col-span-2'>
            ...
            <div className='space-y-6'>
              ...
              <hr className='border-[var(--color-borderColor)] my-6' />
            ...
            <form onSubmit={handleSubmit} className='shadow-lg h-max sticky top-18 rounded-xl p-6 space-y-6 text-gray-500'>
              ...
              <div className='flex flex-col gap-2'>
                ...
                <input type="date" className=' border border-[var(--color-borderColor)] px-3 py-2 rounded-lg' 
              ...
              <button className='w-full bg-[var(--color-primary)] hover:bg-[var(--color-primary-dull;)] transition-all py-3 font-medium text-white rounded-xl cursor-pointer'>Book Now</button>
