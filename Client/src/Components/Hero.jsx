...
const Hero = () => {
  ...
  return (
    <div className='h-screen flex flex-col items-center justify-center gap-14 bg-[var(--color-light)] text-center'>
        ...
        p-6 rounded-lg md:rounded-full w-full max-w-80 md:max-w-200 bg-white shadow-[0px_8px_20px_rgba(0,0,0,0.1)]'>
         ...
         <button className='flex items-center justify-center gap-1 px-9 py-3
            max-sm:mt-4 bg-[var(--color-primary)] hover:bg-[var(--color-primary-dull)] text-white rounded-full
            cursor-pointer'> <img src={assets.search_icon} alt="search" className='brightness-300'/> Search</button>
